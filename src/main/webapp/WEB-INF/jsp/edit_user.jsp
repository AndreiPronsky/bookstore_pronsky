...
<form:form action="/users/edit" method="post" modelAttribute="user">
    ...
    <table>
        <tr>
            ...
            <td><form:input type="text" path="firstName" minlength="1" value="${user.firstName}"/></td>
            <td><form:errors path="firstName"/></td>
        </tr>
        <tr>
            <td><spring:message code="lastname"/></td>
            <td><form:input type="text" path="lastName" minlength="1" value="${user.lastName}"/></td>
        ...
        <tr>
            ...
            <td><form:input type="number" path="rating" value="${user.rating}" step="0.01"/></td>
