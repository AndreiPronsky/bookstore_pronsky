...
INSERT INTO users (firstname, lastname, email, "password", role_id, preferred_locale)
VALUES ('Vladimir', 'Ulyanov', 'bolshevik1870@mail.ussr', '5695476E3B59B2294B494AC032DE1BBBD7A379B7',
        (SELECT r.id FROM roles r WHERE r.name = 'USER'), 'ru'),
       ('Bob', 'Marley', 'reggaeKing45@ja.maica', '44E9E72697F6A934F000328A4522C713F9B4BAEF',
        (SELECT r.id FROM roles r WHERE r.name = 'USER'), 'en'),
